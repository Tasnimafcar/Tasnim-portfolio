...
function IntroScreen({ onComplete }) {
  ...
  useEffect(() => {
    ...
    const t1 = setTimeout(() => setPhase("converge"), 40 + 1400);
    const t2 = setTimeout(() => setPhase("blast"), 40 + 1400 + 650);
    const t3 = setTimeout(() => setPhase("exit"), 40 + 1400 + 650 + 620);
    const t4 = setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-0 h-0 flex items-center justify-center">
            ...
            <div
              ...
              style={{
                ...
                transition: `transform 0.9s cubic-bezier(0.34, 1.56, 0.64, 1) ${
                  entered && phase === "enter" ? pos.delay : 0
                }ms, opacity 0.5s ease ${entered && phase === "enter" ? pos.delay : 0}ms`,
              }}
            >
        ...
        {/* the blast */}
        <div
          className="absolute rounded-full ml-[-75vmax] mt-[-75vmax]"
          style={{
            width: "150vmax",
            height: "150vmax",
        ...
        <div
          ...
          style={{
            ...
            opacity: exiting ? 1 : 0,
            transition: "transform 0.55s cubic-bezier(0.16, 1, 0.3, 1) 0.05s, opacity 0.15s ease",
          }}
        />
      </div>
...
function useTypewriter(lines, speed = 32, pause = 550) {
...
export default function Portfolio() {
  ...
  const { out, done } = useTypewriter(bootLines);
